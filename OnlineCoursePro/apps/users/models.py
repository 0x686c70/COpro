...
class UserProfile(AbstractUser):
    ...
    gender = models.CharField(choices=(('male', u'男'), ('female', u'女')), default='female', max_length=15)
    address = models.CharField(max_length=100, default="")
    mobile = models.CharField(max_length=11, null=True, blank=True)
    image = models.ImageField(upload_to='userimage/%Y/%m/%d', default=u'userimage/default.png', max_length=100)
